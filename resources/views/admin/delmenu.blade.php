                ...
                <div class="item">
                    <div class="pad15">
                      ...
                      height:100px">
                        ...
                        <a href="{{ url("admin/delmenu1/$mmfood->id") }}">  <button class="button-62" role="button">Delete</button></a>
                    </div>
            </div>
                ...
                <div class="item">
                    <div class="pad15">
                      ...
                      height:100px">
                        ...
                        <a href="{{ url("admin/delmenu2/$kfood->id") }}">  <button class="button-62" role="button">Delete</button></a>
