...
<h2 style="text-align: center;color:black" >Insert Menu To Popular food</h2>

@include('admin/insert')


@include('admin/insertintomm')
...
@if (session('status'))
            ...
            <form action="{{ url('http://localhost:8000/admin/adminhome') }}" method="POST">
                @csrf

                <h2 style="text-align: center;">K-food</h2>
